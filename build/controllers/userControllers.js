...
exports.registerUser = (0, catchAsyncErrors_1.catchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (emailExist) {
            return next(new ErrorHandler_1.default(`Email ${email} already exists`, 400));
        }
        const user = {
            name,
            email,
        ...
        try {
            ...
            return next(new ErrorHandler_1.default("There is an error sending you an email", 400));
        }
    }
    catch (error) {
...
exports.updateAccessToken = (0, catchAsyncErrors_1.catchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!session) {
            return next(new ErrorHandler_1.default("Please login to access this resourse!", 403));
        }
...
exports.getUserInfo = (0, catchAsyncErrors_1.catchAsyncError)(async (req, res, next) => {
    try {
        const userId = req.user?._id;
        (0, userServices_1.getUserById)(userId, res);
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.message, 400));
    }
...
exports.updateImage = (0, catchAsyncErrors_1.catchAsyncError)(async (req, res, next) => {
    try {
...
exports.getAllUsers = (0, catchAsyncErrors_1.catchAsyncError)(async (req, res, next) => {
    try {
        (0, userServices_1.getAllUsersService)(res);
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.message, 400));
    }
...
exports.updateUserRole = (0, catchAsyncErrors_1.catchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (isUserExist) {
            ...
            (0, userServices_1.updateUserRoleService)(res, id, role);
        }
        else {
            res.status(400).json({
                success: false,
